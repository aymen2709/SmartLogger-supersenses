...
const PrivacyPolicy = () => {
    return (
        <Layout>
            <div className='container privacy-policy-component'>
                <div className='row equal'>
                    <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div className='privacy-policy-box'>
                            <div className='title text-center'>
                                <h2 className='privacy-title'><strong>Privacy Policy</strong></h2>
                            </div>
                            <div className='text'>
                                <p>Super Senses built the Municipality/Hodhod applications as commercial apps.
                                    This SERVICE is provided by Super Senses and is intended for use as is.</p>
                                ...
                                <p>The terms used in this Privacy Policy have the same meanings as in our Terms
                                    and Conditions, which is accessible at our applications, unless otherwise defined
                                    in this Privacy Policy.</p>

                                <p><strong>Information Collection and Use</strong></p>
                                <p>For a better experience while using our Service, we may require you to provide certain
                                    personally identifiable information, including but not limited to phones numbers,
                                    emails, locations and pictures. The information that we request will be
                                ...
                                <p>We want to inform you that whenever you use our Service, in case of an error in
                                    ...
                                    devices’s Internet Protocol (“IP”) address, device name, operating system version,
                                    configuration of the app when utilising our Service, the time and date
                                ...
                                <p>This Service does not address anyone under the age of 13. We do not knowingly
